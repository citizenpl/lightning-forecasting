...
input_data_train0 = input_data_help[0:round(input_data_help.shape[0] * 0.75), :,11]
input_data_train1 = input_data_help[0:round(input_data_help.shape[0] * 0.75), :, 7]
input_data_train2 = input_data_help[0:round(input_data_help.shape[0] * 0.75), :, 3]
...
input_data_test0 = input_data_help[round(input_data_help.shape[0] * 0.75):, :,11]
input_data_test1 = input_data_help[round(input_data_help.shape[0] * 0.75):, :, 7]
input_data_test2 = input_data_help[round(input_data_help.shape[0] * 0.75):, :, 3]
...
filetosave_0="C:/Users/plgeo/OneDrive/PC Desktop/MATLAB DRIVE/MSc_Meteorology/GBM_classifier_validation_results_north_area_res_12km.xlsx"
filetowrite_0=pd.ExcelWriter(filetosave_0, engine='xlsxwriter')##excel file to save processed data
filetosave_3="C:/Users/plgeo/OneDrive/PC Desktop/MATLAB DRIVE/MSc_Meteorology/GBM_classifier_advanced_scores_north_area_res_12km.xlsx"
...
df_head1.to_excel(filetowrite_0, sheet_name='north area', engine="xlsxwriter", startrow=1, startcol=8, header=True)
df_best_gbclass.to_excel(filetowrite_0, sheet_name='north area', engine="xlsxwriter", startrow=2, startcol=8, header=True)
df_gbheader1 = pd.DataFrame([], columns=["", "", "Bayesian optimized GBM classifier validation scores", "", ""])
df_gbheader1.to_excel(filetowrite_0, sheet_name='north area', engine="xlsxwriter", startrow=1,startcol=0, header=True)
class_val_report_gb, list_val_scores_gb = evaluate_classifier(best_gbclassmodel, train_validation_set)
class_val_report_gb.to_excel(filetowrite_0, sheet_name='north area', engine="xlsxwriter", startrow=2,startcol=0, header=True)
...
df_gbheader2.to_excel(filetowrite_0, sheet_name='north area', engine="xlsxwriter", startrow=9, startcol=0, header=True)
class_report_gb.to_excel(filetowrite_0, sheet_name='north area', engine="xlsxwriter", startrow=10,startcol=0, header=True)
...
df_gbheader3.to_excel(filetowrite_0, sheet_name='north area', engine="xlsxwriter", startrow=17, startcol=0, header=True)
class_report_cgb.to_excel(filetowrite_0, sheet_name='north area', engine="xlsxwriter", startrow=18,startcol=0, header=True)

filetosave1 = directory_to_save_models + 'GB_classifier_' + 'north_area.sav'
...
df_validation_scores.to_excel(filetowrite_3, sheet_name='north area', engine="xlsxwriter", startrow=1, startcol=0,header=True)
...
df_test_scores.to_excel(filetowrite_3, sheet_name='north area', engine="xlsxwriter", startrow=8, startcol=0, header=True)
...
df_test_scoresc.to_excel(filetowrite_3, sheet_name='north area', engine="xlsxwriter", startrow=12, startcol=0, header=True)
filetowrite_0.save()
filetowrite_3.save()
...
plt.xlabel("GBM classifier north area feature importance")
plt.savefig(directory_to_save_figures+'XGBoost classifier north area feature importances.png',dpi='figure', format=None, metadata=None,
